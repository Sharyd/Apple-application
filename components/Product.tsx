...
const Product = ({ product }: Props) => {
  ...
  return (
    <div className="flex h-fit w-[320px] select-none flex-col space-y-3 rounded-xl bg-[#ffffffee] p-8 md:h-[500px] md:w-[400px] md:p-10">
      ...
      <div className="flex flex-1 items-center justify-between space-x-3">
        ...
        >
          <ShoppingCartIcon className="h-8 w-8 text-[#35383c]" />
        </div>
      </div>
    </div>
  );
